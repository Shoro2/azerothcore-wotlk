...
public:
    ...
    void RollPossibleEnchant(Player* player, Item* item)
    {
        ...
        if (slotRand[4] != -1)
            chathandle.PSendSysMessage("Newly Acquired |cffFF0000 %s |rhas received|cffFF0000 5 sick |rrandom enchantments!", item->GetTemplate()->Name1.c_str());
        else if (slotRand[3] != -1)
            chathandle.PSendSysMessage("Newly Acquired |cffFF0000 %s |rhas received|cffFF0000 4 |rrandom enchantments!", item->GetTemplate()->Name1.c_str());
