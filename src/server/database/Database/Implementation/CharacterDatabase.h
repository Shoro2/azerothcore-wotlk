...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_FORGOTTEN_POWER,
    CHAR_INS_FORGOTTEN_POWER,
    CHAR_UPD_FORGOTTEN_POWER_ADD,
    CHAR_UPD_FORGOTTEN_POWER_SET,
    CHAR_UPD_FORGOTTEN_REVISION,
    CHAR_UPD_FORGOTTEN_SELECTED_LOADOUT,
    CHAR_SEL_FORGOTTEN_LOADOUTS,
    CHAR_INS_FORGOTTEN_LOADOUT,
    CHAR_UPD_FORGOTTEN_LOADOUT,
    CHAR_DEL_FORGOTTEN_LOADOUT,
    CHAR_SEL_FORGOTTEN_NODES,
    CHAR_DEL_FORGOTTEN_NODES,
    CHAR_DEL_FORGOTTEN_NODES_BY_GUID,
    CHAR_INS_FORGOTTEN_NODE,
    CHAR_SEL_FORGOTTEN_GRANTS,
    CHAR_INS_FORGOTTEN_GRANT,
    CHAR_DEL_FORGOTTEN_GRANT,
    CHAR_DEL_FORGOTTEN_GRANTS,
    CHAR_INS_FORGOTTEN_LEDGER,
    CHAR_DEL_FORGOTTEN_POWER,
    CHAR_DEL_FORGOTTEN_LOADOUTS,
    CHAR_DEL_FORGOTTEN_LEDGER,

    // mod-paragon-itemgen
    CHAR_SEL_PARAGON_ROLE,
    CHAR_INS_PARAGON_ROLE,
    CHAR_UPD_PARAGON_ROLE_MAINSTAT,
    CHAR_SEL_PARAGON_SPEC,
    CHAR_REP_PARAGON_SPEC,
    CHAR_REP_PARAGON_ITEM,
    CHAR_SEL_PARAGON_ITEM_LEVEL,
    CHAR_SEL_PARAGON_LEVEL_BY_CHAR,
