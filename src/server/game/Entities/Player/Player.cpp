...
void Player::AddSpellMod(SpellModifier* mod, bool apply)
{
    ...
    // FL: always the stock 6-byte layout - CoA's 11-byte Ascension layout is not ported (our client
    // is 3.3.5a 12340). Ops past the client's table are applied server-side and never sent.
    int i = 0;
    flag96 _mask = 0;
