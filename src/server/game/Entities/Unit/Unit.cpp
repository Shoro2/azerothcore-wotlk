...
{
    return MeleeSpellHitResult(victim, spellInfo, MAX_ATTACK);
}

SpellMissInfo Unit::MeleeSpellHitResult(Unit* victim, SpellInfo const* spellInfo, WeaponAttackType scriptedAttackType)
{
