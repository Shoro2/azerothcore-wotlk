...
public:
    ...
    */
    ...
    // CoA core port: a script-chosen melee attack type (OFF_ATTACK) rolls the off-hand's avoidance
    [[nodiscard]] SpellMissInfo MeleeSpellHitResult(Unit* victim, SpellInfo const* spell, WeaponAttackType scriptedAttackType);
