...
public:
    ...
    // CoA core port: the playerbots-era names of the hooks above, kept beside upstream's so
    // CoA-derived code keeps compiling. Not in DatabaseHook; dispatched to every DatabaseScript.
